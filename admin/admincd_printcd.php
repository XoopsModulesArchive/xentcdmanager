<?php
    ...
    $sql = 'SELECT * FROM ' . $xoopsDB->prefix($module_tables[1]);
    ...
    echo "<table width='100%' border='1' cellspacing='0' style='border-collapse: collapse' bordercolor='#111111' cellpadding='2'><th align='left'><a href='admincd_printcd.php?tri=1'>Numéro</a></th><th align='left'><a href='admincd_printcd.php?tri=2'>Nom</a></th>";
